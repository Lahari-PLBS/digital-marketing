      ...
      <div className="relative z-10 py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <p className="text-white text-md uppercase tracking-wider mb-4">
              TESTIMONIALS
            </p>
          ...
          <div className="relative">
            ...
            <button
              onClick={prevSlide}
              className="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-6 z-20 bg-white rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105"
            >
            ...
            <button
              onClick={nextSlide}
              className="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-6 z-20 bg-white rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105"
            >
            ...
            <div className="overflow-hidden">
              ...
              >
                {testimonials.map((testimonial, index) => (
                  ...
                  >
                    <div className="bg-white rounded-lg p-8 shadow-xl h-full flex flex-col">
                      {/* Quote Icon */}
                      <div className="mb-6">
